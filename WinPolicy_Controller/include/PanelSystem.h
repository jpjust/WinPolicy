/* Class:       PanelSystem
 * Description: WinPolicy "System" panel.
 *
...
const long ID_PANELSYSTEM_BTN_CHECKALL = wxNewId();
const long ID_PANELSYSTEM_BTN_UNCHECKALL = wxNewId();

using namespace std;

class PanelSystem : public wxScrolledWindow
{
public:
