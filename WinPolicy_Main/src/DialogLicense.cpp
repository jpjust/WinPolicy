...
#ifdef _WINPOLICY_FREEWARE_		// Contrato Freeware

char justsoft_license[] = wxT("LICEN�A JUSTSOFT PARA SOFTWARE FREEWARE\n" \
"Vers�o 1.2 (16/08/2006)\n" \
"---------------------------------------\n" \
"Copyright (c) 2004 - 2005 Justsoft Inform�tica Ltda.\n" \
...
"\n" \
"1) Distribuir o software em disquetes ou qualquer outro tipo de m�dia ou pela Internet e redes, sem modific�-lo em hip�tese alguma;\n" \
"\n" \
"2) Usar este software em quantos computadores desejar, tanto em ambiente pessoal (residencial), acad�mico ou corporativo; e\n" \
"\n" \
"3) Inserir links para este software ou seu Site em Home Page pessoal ou corporativa sendo que o nome da Justsoft Inform�tica Ltda. seja exibido.\n" \
"\n" \
"\n" \
"� proibido ao usu�rio:\n" \
"\n" \
"1) Modificar, traduzir o software ou copiar partes deste para outros softwares sem autoriza��o da Justsoft Inform�tica Ltda.; e\n" \
"\n" \
"2) Vender, distribuir, publicar ou revender licen�as falsas ou o software sem permiss�o da Justsoft Inform�tica Ltda.\n" \
"\n" \
"\n" \
"O software, sendo freeware, pode ser instalado em um n�mero infinito de computadores sem a necessidade de comprar licen�as. Esta liberdade de uso do software freeware tamb�m se aplica para pessoas jur�dicas.\n" \
"\n" \
...
#else				// Contrato n�o-freeware

char justsoft_license[] = wxT("LICEN�A JUSTSOFT PARA SOFTWARE N�O-FREEWARE\n" \
...
DialogLicense::DialogLicense(void)
	:wxDialog(NULL, -1, "Licen�a", wxDefaultPosition, wxSize(400, 400))
{
	...
	btn_close = new wxButton(this, ID_DIALOGLICENSE_BTN_CLOSE, "Fechar");
